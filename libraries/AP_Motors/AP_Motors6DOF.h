...
public:
    ...
    void                set_forward(float forward_in) { _strafe_in = constrain_float(forward_in,1100.0f,1900.0f); };        // range 1100~1900 this is raw pwm value from rc
    void                set_strafe(float strafe_in) { _strafe_in = constrain_float(strafe_in,1100.0f,1900.0f); };           // range 1100~1900 this is raw pwm value from rc
